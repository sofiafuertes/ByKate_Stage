    ...
    <section class="productsSection">
        ...
        <div class="productsContainer">
            <div class="imgProduct">
                <img src="./photos/products/chocotorta.jpg" alt="Foto chocotorta">
            </div>
            <div class="imgProduct">
                <img src="./photos/products/keyLimePie.jpg" alt="Foto Tarta Key Lime Pie">
            </div>
            <div class="imgProduct">
                <img src="./photos/products/pastelChoco.jpg" alt="Foto Pastel de Chocolate">
            </div>
            <div class="imgProduct">
            ...
            <div class="aboutUsRight">
                ...
                <div class="aboutUsText">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis, est. Lorem ipsum dolor sit
                        amet
                        consectetur adipisicing elit. Amet nulla molestiae consequatur nemo earum eligendi, odit iusto
